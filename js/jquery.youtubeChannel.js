...
;(function($){
    $.fn.youtubeChannel = function(settings) {
        ...
        var version         = {major:0,minor:5,build:10},
            ...
            $ytEl           = $(this),
            // the list element
            $ytList         = $('<ul/>',{'class':'yt-channel-list','id':'aa'}),
            // the header
            $ytHead,
        ...
        // set the header
        $ytHead = $('<li/>',{'class':'yt-channel-title'}).html('Videos Recientes');
        // set copyright notice
        $ytFoot = $('<li/>',{'class':'yt-channel-copy'}).html('videos www.origencanario.com');
